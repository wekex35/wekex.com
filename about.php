			...
			<div class="row clearfix">
				...
				<div class="services-block-three style-two col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="text">We are committed to driving innovation and provide quality offerings to the organizations to help them better serve their end users beyond the expectations and build a better business. We diversify our endeavours and direct our organizational efforts to fulfil a longstanding promise of helping the businesses to achieve excellence, better levels of profitable growth and improve the brand recognition leveraging advanced technology.</div>
					</div>
				</div>
				...
				<div class="services-block-three style-two col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeIn" data-wow-delay="300ms" data-wow-duration="1500ms">
						...
						<h6><a href="#">Why we</a></h6>
						<div class="text">We understand our client’s business requirement and strive hard to deliver the best possible solution. We combine the industry knowledge with technology competence to deliver the high end quality solutions in a cost effective manner to maximize your competitive advantage and increase your business productivity..</div>
					</div>
				</div>
				...
				<div class="services-block-three style-two col-lg-4 col-md-12 col-sm-12">
					<div class="inner-box wow fadeIn" data-wow-delay="600ms" data-wow-duration="1500ms">
						...
						<h6><a href="#">Quality Policy</a></h6>
						<div class="text">The staff and management of WebshineTech are committed to consistent provision of quality products and services that will satisfy the demands and expectations of customers by continual improvement of the QMS and confirming to Global Standards and prevailing codes of practice.</div>
					</div>
				</div>
				...
				<div class="skills-column col-lg-7 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="skills style-two">
							...
							<div class="skill-item">
								<div class="skill-header clearfix">
									<div class="skill-title">Wordpress and CRM </div>
									<div class="skill-percentage"><div class="count-box"><span class="count-text" data-speed="2000" data-stop="90">0</span>%</div></div>
								</div>
								<div class="skill-bar">
									<div class="bar-inner"><div class="bar progress-line" data-width="90"></div></div>
							...
							<div class="skill-item">
								<div class="skill-header clearfix">
									<div class="skill-title">Circuit Designing</div>
							...
							<div class="skill-item">
								<div class="skill-header clearfix">
									<div class="skill-title">Firmware Development</div>
									<div class="skill-percentage"><div class="count-box"><span class="count-text" data-speed="2000" data-stop="95">0</span>%</div></div>
								</div>
								<div class="skill-bar">
									<div class="bar-inner"><div class="bar progress-line" data-width="95"></div></div>
			...
			<div class="sec-title">
				<div class="clearfix">
					...
					<div class="pull-right">
						<div class="text">Our culture of excellence extends throughout the organization, influencing our approach to project leadership, the way our teams collaborate with clients, and our commitment to innovation. We are customer centric company, which starts and ends with the customer requirements, satisfaction and happiness</div>
					</div>
				</div>
			</div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12">
                        ...
                        <ul class="tab-btns tab-buttons clearfix">
                            <li data-tab="#feature-expert" class="tab-btn">Expert Team <span>We bring together experts from different disciplines to work collaboratively as a single unit. This integrated approach simplifies the process of bringing buildings to life.</span></li>
                            <li data-tab="#feature-brand" class="tab-btn active-btn">Design & Delivery<span>Our Design & Delivery approach, commitment to sustainability, and culture of excellence are unique. Clients benefit from our collaborative process and dedication to serving as trusted advisors.</span></li>
                            <li data-tab="#feature-ideas" class="tab-btn">Commitment<span>We abide by all the commitments and offer the most competitive customer support to your clients</span></li>
                        </ul>
                    </div>
                    <!--Column-->
